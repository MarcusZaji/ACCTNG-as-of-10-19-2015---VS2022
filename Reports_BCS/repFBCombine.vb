...
Partial Public Class repFBCombine

    Inherits Telerik.Reporting.Report
    Public Sub New()
        InitializeComponent()

        Me.ReportParameters("DEPT").Value = Convert.ToString(frmGenReportBC.ddlDept.Text)
        Me.ReportParameters("BYEAR").Value = Convert.ToString(frmGenReportBC.ddlYear.Text)
        ...
        'txtPHPtoJPY.Value = Convert.ToString(drJPY_PHP.Item("Amount").ToString)
        'txtUSDtoJPY.Value = Convert.ToString(drUSD_YEN.Item("Amount").ToString)
